...
alias ak='bash ~/scripts/id/ak.sh'
...
alias kartik='bash ~/scripts/id/kartik.sh'
...
alias gs='git status'
alias b='. build/envsetup.sh && export USE_CCACHE=1 && ccache -M 50G && export CONFIG_STATE_NOTIFIER=y && export SELINUX_IGNORE_NEVERALLOWS=true && brunch RMX1851'
